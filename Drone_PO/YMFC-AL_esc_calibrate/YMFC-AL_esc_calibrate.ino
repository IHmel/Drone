...
void loop() {
  ...
  if (Serial.available() > 0) {
    ...
    start = 0;
    first_angle = false;
    if (data == 'r')Serial.println("Чтение сигналов приемника.");
    if (data == 'a') {
      Serial.println("Вывод ориентации квадрокоптера.");
      Serial.println("Данные с гироскопа.");
    }
    if (data == 'a')Serial.println("Калибровка гироскопа начнется через 2 секунды (не двигайте его).");
    if (data == '1')Serial.println("Тест мотора 1 (правый передний CCW.)");
    if (data == '2')Serial.println("Тест мотора 2 (правый задний rear CW.)");
    if (data == '3')Serial.println("Тест мотора 3 (левый задний rear CCW.)");
    if (data == '4')Serial.println("Тест мотора 4 (левый передний CW.)");
    if (data == '5')Serial.println("Тест всех моторов вместе");
  ...
  if (data == 'a') {
    ...
    if (cal_int != 2000) {
      Serial.print("Калибровка гироскопа...");
      ...
      if (loop_counter == 0)Serial.print("Тангаж/Pitch: ");
      if (loop_counter == 1)Serial.print(angle_pitch, 0);
      if (loop_counter == 2)Serial.print(" Крен/Roll: ");
      if (loop_counter == 3)Serial.print(angle_roll, 0);
      if (loop_counter == 4)Serial.print(" Рысканье/Yaw: ");
